...
// LocalStorage uses ./dockvol_local_backups folder as a
// directory for backups and ./dockvol_local_temp folder as a
// directory for temp files
type LocalStorage struct {
	StorageID uuid.UUID `json:"storageId" gorm:"primaryKey;column:storage_id"`
}
