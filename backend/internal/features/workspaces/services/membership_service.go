...
import (
	...
	users_enums "dockvol-backend/internal/features/users/enums"
	...
	workspaces_errors "dockvol-backend/internal/features/workspaces/errors"
...
func (s *MembershipService) buildInvitationEmailHTML(
	...
	if env.DockVolURL != "" {
		...
		signUpLink = `<p style="margin: 20px 0; color: #666;">
			Please visit your DockVol instance to sign up and access the workspace.
		</p>`
	}
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
	<div style="background-color: #f8f9fa; border-radius: 8px; padding: 30px; margin: 20px 0;">
		...
		<p style="font-size: 14px; color: #6c757d; margin: 0;">
			This is an automated message from DockVol. If you didn't expect this invitation, you can safely ignore this email.
		</p>
	</div>
</body>
</html>
