  ...
  return (
    <div className="flex grow">
      <div className="w-full">
        ...
        >
          <h1 className="text-2xl font-bold dark:text-white">DockVol settings</h1>
                  ...
                  <div className="flex items-start justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
                    <div className="flex-1 pr-20">
                      ...
                      <div className="mt-1 text-gray-500 dark:text-gray-400">
                        When enabled, new users can register accounts in DockVol. If disabled, new
                  ...
                  {!formSettings.isAllowExternalRegistrations && (
                    <div className="flex items-start justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
                      <div className="flex-1 pr-20">
                        ...
                        <div className="mt-1 text-gray-500 dark:text-gray-400">
                          When enabled, existing members can invite new users to join DockVol. If
          ...
          <div className="my-8 max-w-2xl">
            ...
            <div className="group relative">
              ...
              <div className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Use this endpoint to monitor your DockVol system&apos;s availability
              </div>
            </div>
          </div>
